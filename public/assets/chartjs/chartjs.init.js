...
!function($) {
    ...
    ChartJs.prototype.init = function() {
        ...
        var mar = sessionStorage.getItem("mar");
        var apr = sessionStorage.getItem("apr");
        var may = sessionStorage.getItem("jun");
        var jun = sessionStorage.getItem("jum");
        var jul = sessionStorage.getItem("jul");
        var aug = sessionStorage.getItem("aug");
        var sep = sessionStorage.getItem("sep");
