...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">Cancelled Operation Details</h3></div>
            <div class="row">
             </div>
             <br>
              <div class="row">
                    <div class="col-md-12">
                                 ...
                                 <tr>
                                    ...
                                    <td><a href="<?php echo URLROOT;?>/ot/status_cancel_update/<?php echo $key->ot_id; ?>" class="btn btn-info btn-xs m-b-5"> Restore</a> </td>
                                 </tr>
                                 <?php } } ?>	
                                                </tbody>
                                            </table>
