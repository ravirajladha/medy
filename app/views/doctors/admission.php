...
$operationDetails = $doc_obj->getTheOperationDetails($admit_id.'IP');
?>
		...
		<div class="col-md-12">
			<div class="panel panel-default">
                ...
                <div class="col-md-4">
                	...
                	<div class="col-lg-12">
                		<b>Doctor:</b> <?php echo ucwords($doc_name);?>
                	</div>
                	<div class="col-lg-12">
                ...
                <div class="col-md-8" style="margin-left: 0px;">
                	<br><br><button style="float: right;" class="btn btn-pink btn-xs m-b-5" data-toggle="modal" data-target="#ot_modal"><i class="fa fa-heartbeat" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;OR</button><br><br>
                	<?php
                	if($dis != NULL)
                	{ ?>
					...
					<a data-target="#ipTeam" data-toggle="modal" >
                	<button style="float: right; width: 115px;  margin-left: 5px;" class="btn btn-primary btn-xs m-b-5">Assign Team</button>

					</a>
					<?php if($operationDetails) { ?>
						<a href="<?php echo URLROOT; ?>/doctors/teamAssign/<?php echo $operationDetails->ot_id; ?>,<?php echo $patient_id; ?>" rel="noopener noreferrer">
						<button style="float: right;  width: 115px;  margin-left: px;" class="btn btn-info btn-xs m-b-5">Operation Team</button>
						</a>
                	<?php } ?>
                </div>
            	</div>
            ...
            <div class="panel panel-default p-0  m-t-20">
                <div class="panel-body p-0">
                    <div class="list-group no-border mail-list">
                      ...
                      <a href="#homenew1" data-toggle="tab" aria-expanded="true" class="list-group-item no_act">Medication / Advice</a>
                      <a href="#homenew2" data-toggle="tab" aria-expanded="true" class="list-group-item no_act"> Reports</a>
                        ...
                        <div class="modal-footer"> 
                            <button type="button" class="btn btn-white" data-dismiss="modal">Close</button> 
            					...
            					<div class="tab-pane" id="homenew1">
									<div class="row">
										<form action="<?php echo URLROOT; ?>/doctors/save_advice_for_discharge/<?php echo $patient_id; ?>/<?php echo $admit_id ?>" method="post">
            					...
            					<div class="tab-pane" id="home3">
            						<div class="col-lg-12">
										<form action="<?php echo URLROOT;?>/doctors/patient_history/<?php echo $patient_id; ?>" method="POST">
										<input type="number" name="pat" value="<?php echo $patient_id;?>" style="display: none;">
            							<div class="form-group">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  style="text-align: left;">
                                                    	<a href="<?php echo URLROOT;?>/doctors/discharge_summary/<?php echo $keys->ipd_admit_id;?>,<?php echo $patient_id; ?>">
                                    ...
                                    <div class="col-md-12">
						                <div class="form-group">
											<label for="exampleInputEmail1">Enter Admit ID</label>
						                        <input style="margin-top: 10px;" name="report_up" type="text" class="form-control autocomplete" placeholder="" id="a" value="<?php echo $admit_id ?>" readonly>
									    </div>
									</div>
									<div class="col-md-12">
						                <div class="form-group">
