            ...
            <div class="panel panel-default p-0">
                <div class="panel-body p-0"> 
                    ...
                    <div id="user-activities" class="tab-pane">
                        ...
                        ?>
                            <div class="col-lg-12"> 
                            <span style="float: right;"><a href="<?php echo URLROOT; ?>/doctors/timeslots/<?php echo $_SESSION['user_id_medhike_87_71_18_08_80_none_med_hi_ke_no']; ?>"><i class="fa fa-pencil" aria-hidden="true">&nbsp;&nbsp;</i><u>Edit Timeslots</u></a></span><br><br>
                                <ul class="nav nav-tabs nav-justified"> 
                                    ...
                                    <?php } ?>"> 
                                        <a href="#mon" data-toggle="tab" aria-expanded="flase"> 
                                            <span class="visible-xs">Monday</i></span> 
                                    ...
                                    <?php } ?>"> 
                                        <a href="#tue" data-toggle="tab" aria-expanded="false"> 
                                            <span class="visible-xs">Tuesday</i></span> 
                            ...
                            <?php } else { ?>
                                <span style="float: right;"><a href="<?php echo URLROOT; ?>/doctors/timeslots/<?php echo $_SESSION['user_id_medhike_87_71_18_08_80_none_med_hi_ke_no']; ?>"><i class="ion-clock" aria-hidden="true">&nbsp;&nbsp;</i><u>Add Timeslots</u></a></span>
