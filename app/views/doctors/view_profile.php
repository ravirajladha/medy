                        ...
                        <div class="timeline-2">
                            <div class="time-item">
                                <div class="item-info">
                                    ...
                                    <p><strong>Doctor: <x class="text-info"><?php echo ucwords($doc_name);?></x></strong></p>
                                    <p><strong>Purpose: <x class="text-info"><?php echo ucwords($pur) ;?></x></strong></p>
                                    <a data-toggle="modal" href="#con-close-modal<?php echo $visit_id;?>" class="hvrEff" style="font-size: 14px; color: #F0B27A;">Know More <l>→</l></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-dialog"> 
                                    <div class="modal-content"> 
                                        <div class="modal-header"> 
                                            <button type="button" data-dismiss="modal" aria-hidden="true" class="close1">×</button> 
                                        ...
                                        <div class="modal-body"> 
                                            <div class="row"> 
                                                ...
                                                <div class="col-md-1"> 
                                                    <a href="<?php echo URLROOT;?>/doctors/print_prescription/<?php echo $visit_id;?>"><button type="button" class="btn btn-info btn-xs m-b-5"> Print </button></a><br>
                                                </div> 
                                            </div> 
                                            <div class="row"> 
                                                <div class="col-md-12"> 
                        ...
                        <div class="timeline-2">
                            <div class="time-item">
                                <div class="item-info">
                                    ...
                                    <form action="<?php echo URLROOT; ?>/doctors/discharge_summary_doc" method="POST">
                                    ...
                                    <a href="<?php echo URLROOT; ?>/doctors/print_admit_medicines/<?php echo $ipd->ipd_admit_id; ?>"><button class="btn btn-purple btn-xs m-b-5">Print Medicine</button></a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
