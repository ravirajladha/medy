...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">All reports</h3></div>
            <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="table-responsive">
                          <table class="table">
                              <thead>
                                  <tr>
								  	  <th class="col-md-2" style="text-align:left;">Patient</th>
                                      <th class="col-md-2">Visit/Admit Id</th>
                                      <th class="col-md-3" style="text-align: left;">Report Title</th>
                                      <th class="col-md-3" style="text-align: left">File_attached</th>
                                      <th class="col-md-2" style="text-align: left;">Uploaded Date</th>
                                      <th class="col-md-2" style="text-align: left;">Action</th>
                                  </tr>
                              </thead>
  ...
  $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/doctors/all_xray1',
                data: {lim,off},
                cache: false,
  ...
  $(document).ready(function(){
        $("#service_id_value").keyup(function(){
          ...
          if(inv!=0)
          {
            $.ajax({
              type:'POST',
              url:'<?php echo URLROOT;?>/doctors/search_by_xray_id',
              data:{inv},
...
<script type="text/javascript">
    function confirm_sec(ser_id)
    {
        if (confirm('Are you sure?'))
        {
            $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/doctors/delete_xray',
                data: {ser_id,ser_id},
                cache: false,
                success:function(response)
                {
