...
<div class="wraper container-fluid">
               ...
               <div class="row">
                    <div class="col-lg-3 col-sm-6">
                    	<a href="<?php echo URLROOT;?>/pharmacies/new_order">
                    ...
                    <div class="col-lg-3 col-sm-6">
                            <a href="<?php echo URLROOT;?>/pharmacies/add_drugs">
                        <div class="widget-panel widget-style-2 white-bg">
                    ...
                    <div class="col-lg-3 col-sm-6">
                         <a href="<?php echo URLROOT;?>/pharmacies/new_purchase">
                        <div class="widget-panel widget-style-2 white-bg">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="widget-panel widget-style-2 white-bg">
                            ...
                            <h2 style="color: gray" class="m-0 counter">145</h2>
