...
$(document).ready(function(){
  ...
  $('#add_row').click(function(){
    ...
    $('#addr1').append('<tr id="row'+i+'">\
            <td class="xyz" id="'+i+'"><input id="set'+i+'" type="text" name="product[]" placeholder="Drug Name/Drug ID/Barcode" class="form-control" autocomplete="off" />\
            <div id="listt'+i+'" class="listt" style="display: none"></div></td>\
            <td><select type="text" id="bat'+i+'" name="bat[]" placeholder="Enter Batch" class="form-control" step="0" min="0"/></select></td>\
...
<div class="col-md-12">
  <div class="panel panel-default">
      ...
      <table class="table table-bordered table-hover" id="tab_logic">
        ...
        <tbody id="addr1">
          <tr>
            <td><input id="searchbox" type="text" name='product[]' placeholder='Drug Name/Drug ID/Barcode' class="form-control searchInput" autocomplete="off" />
            <div id='listt0' style="display: none"></div></td>
            <td><select type="text" id="bat" name='bat[]' placeholder='Enter Batch' class="form-control" step="0" min="0"/></select></td>
