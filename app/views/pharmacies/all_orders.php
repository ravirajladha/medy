  ...
  $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/pharmacies/all_orders1',
                data: {lim,off},
                cache: false,
  ...
  $(document).ready(function(){
        $("#invoice_id_value").keyup(function(){
          ...
          if(inv!=0)
          {
            $.ajax({
              type:'POST',
              url:'<?php echo URLROOT;?>/pharmacies/search_by_inv_id',
              data:{inv},
...
<script type="text/javascript">
  function cancell_order(ser_id)
          {
            if(confirm("Are you Sure??!"))
            {
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/pharmacies/cancel_invoice',
                data: {ser_id},
                cache: false,
                success:function(response)
                {
