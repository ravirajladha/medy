...
<?php
	...
	// {
	// 	$id = $key->patient_id;
	// 	$name = $key->patient_name;
	// 	$phone = $key->patient_phone;
	// 	$email = $key->patient_email;
	// 	$photo = $key->patient_photo;
	// }
	foreach ($data['mem_data1'] as $key1)
	{
		$id = $key1->mem_id;
		$name = $key1->mem_name;
		$phone = $key1->mem_phone;
		$email = $key1->mem_email;
		$photo = $key1->mem_photo;
	}
?>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">Settings</h3></div>
                ...
                <form action="<?php echo URLROOT;?>/patients/update_password" method="POST" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-3">
