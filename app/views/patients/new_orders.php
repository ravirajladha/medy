...
$(document).ready(function(){
  ...
  $('#add_row').click(function(){
    i++;
    $('#addr1').append('<tr id="row'+i+'"><td>'+i+'</td>\
      ...
      <table class="table table-bordered table-hover" id="tab_logic">
        ...
        <tbody id="addr1">
          <tr>
            ...
            { 
            ?>
            <td><input id="searchbox" type="text" name='product[]' placeholder='Test Name' class="form-control searchInput" autocomplete="off" />
            <div id='listt0' class="listt" style="display: none"></div></td>
            <?php 
            } 
            else
            {
            ?>
            <td><input id="searchbox" type="text" name='product[]' placeholder='Service ID / Name' class="form-control searchInput" autocomplete="off" />
  ...
  <div class="row clearfix" style="margin-top:20px">
    ...
    <div class="col-md-4">
      <table class="table table-bordered table-hover" id="tab_logic_total">
        <tbody>
          <tr>
            <th class="text-center">Discount <br>(Amount or %)</th>
            <td class="text-center">
    ...
    <div class="col-md-4">
      ...
      <button style="margin-right: 10px;" id="sp" type="button" class="btn btn-info pull-right" onclick="xsave(<?php echo $val=3;?>);">Submit & Print</button> 
      <button style="margin-right: 10px;" id="sub" type="button" class="btn btn-primary pull-right" onclick="xsave(<?php echo $val=2;?>);">Submit</button>
      <button style="margin-right: 10px;" id="refresh" type="button" class="btn btn-warning pull-right">Cancel</button> 
      <button style="margin-right: 10px;" id="sav" type="button" class="btn btn-lightgray pull-right" onclick="xsave(<?php echo $val=1;?>);">Save</button>
...
<script type='text/javascript'>
  function xsave(b)
  {
    ...
    $.ajax({
              ...
              type:'POST',
              data:{inv_id_edit,status,service_id,invoice_bill,grand_total,patient_name,doctor_name,ipopid,pay_mode,amount_paid,dep_type,b},
              success : function(data)
              {
                    $('#fed').trigger('reset');
