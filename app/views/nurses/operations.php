	            ...
	            <div class="panel-body p-t-10">
	                ...
	                <ul class="social-links list-inline p-b-10">
	                	<div class="row">
	                		...
	                		<a href="<?php echo URLROOT; ?>/nurses/operationDetails/<?php echo $key->ot_id; ?>"><div class="col-sm-4"><button class="btn btn-purple btn-xs m-b-5" style="float: right;"> View Details</button></a></div>
	                	</div>
	                </ul>
	            </div> <!-- panel-body -->
	        </div> <!-- panel -->
