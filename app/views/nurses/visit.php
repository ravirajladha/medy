    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-lg-6">
                        <b>Doctor Name:</b> Dr. <?php echo ucwords($doc_n); ?>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="panel panel-default p-0  m-t-20">
                            <div class="panel-body p-0">
                                <div class="list-group no-border mail-list">
                                  ...
                                  <a href="#home44" data-toggle="tab" aria-expanded="false" class="list-group-item imone">Nursing Service</a>
       ...
       <!-- ######################Present Visit############################ -->
                                            <div class="tab-pane" id="home2">
                                                <form action="<?php echo URLROOT;?>/nurses/save_co_morbidities/<?php echo $p_id;?>" method="POST">
                                                    <div class="col-lg-12">
                                                          <?php
                                                            foreach ($data['gen'] as $key) {
                                                ...
                                                <div class="tab-pane" id="home44">
                                                    <?php
                                                        foreach ($data['opd'] as $opd)
                                                        {
                                                            $nur = explode(',', $opd->nursing_services);
                                                        }
                                                        if($opd->nursing_services)
                                                        {
                                                    ...
                                                    ?>
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                        for ($e=0; $e < sizeof($nur); $e++) { 
                                                                            $doc_obj->getServiceName($nur[$e]);
                                                                    ?>
                                                                    <tr>
                                                                        <td><?php echo $e+1; ?></td>
                                                                        <td style="text-align: left;"><?php echo $doc_obj->getServiceName($nur[$e]); ?></td>
                                                                    </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <?php } ?>
                                                    <form action="<?php echo URLROOT; ?>/nurses/saveNursingServiceOpd" method="POST">
                                                    <div class="col-lg-12">
                                                        <label>Nursing Service</label><span><a href="#" class="btn btn-purple btn-xs m-b-5" style="float: right;" onclick="addRowsTo()">Add Row</a></span>
                                                        <div class="form-group" id="forDivAppend">
                                                            <input type="number" name="visitId" value="<?php echo $opdid; ?>" style="display: none;">
                                                            <input type="number" name="patientId" value="<?php echo $p_id; ?>" style="display: none;">
                                                            <input type="text" name="nursingService[]" class="form-control" onkeyup="callForAutoComplete(0, this.value)" id="nursingKeyup0" placeholder="Enter Service Name">
                                                            <div class="listDisplay" id="listDisplay0"></div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <table class="table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th  style="text-align: ;\0" class="col-lg-2">Action</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody >
                                                                <?php
                                                                ...
                                                                <?php foreach($data['opd2'] as $test) {
                                                                    ...
                                                                    $doc_data = $doc_obj->get_doc($test->opd_doctor_id);
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td  style="text-align: left;">
                                                                        <a href="<?php echo URLROOT;?>/nurses/print_prescription/<?php echo $test->opd_visit_id;?>"><button style="width: 54px" type="button" class="btn btn-success btn-xs m-b-5">Print</button></a>
                                                                        <a href="<?php echo URLROOT;?>/nurses/print_prescription/<?php echo $test->opd_visit_id;?>"><button style="width: 54px" type="button" class="btn btn-purple btn-xs m-b-5">View</button></a>
                                                                    </td>
                                                                </tr> 
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody >
                                                                <?php foreach($data['ipd_d'] as $test) {
                                                                    ...
                                                                    $doc_data = $doc_obj->get_doc($test->ipd_doctor_id);
                                                                    foreach ($doc_data as $value)
                                                                    {
                                                                        $doc_name = $value->doctor_name;
                                                                    }
...
<script type="text/javascript">
    ...
    function addRowsTo()
    {
        $('#forDivAppend').append('<br><input type="text" name="nursingService[]" class="form-control" onkeyup="callForAutoComplete('+y+', this.value)" id="nursingKeyup'+y+'" placeholder="Enter Service Name"><div class="listDisplay" id="listDisplay'+y+'"></div>');
        y++;
    }

    function callForAutoComplete(keyVal, val)
    {
        $.ajax({
