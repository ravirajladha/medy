                ...
                <div class="panel-body p-0"> 
                    ...
                    <div id="user-activities" class="tab-pane">
                        ...
                        <div class="timeline-2">
                            <div class="time-item">
                                <div class="item-info">
                                    <div class="text-muted">Visited: <?php echo date('d-m-Y h:i A', strtotime($visit_date));?></div>
                                    <p><strong>Doctor: <a href="#" class="text-info">Dr. <?php echo ucwords($doc_name);?></a></strong></p>
                                    ...
                                    <div class="modal-content"> 
                                        ...
                                        <div class="modal-body"> 
                                            <div class="row"> 
                                                ...
                                                <div class="col-md-2"> 
                                                    <a href="<?php echo URLROOT;?>/nurses/print_prescription/<?php echo $visit_id;?>"><button type="button" class="btn btn-success w-xs m-b-5"> Print </button></a><br>
                                                </div> 
                                            </div> 
                                            <div class="row"> 
                                                <div class="col-md-12"> 
