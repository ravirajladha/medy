                ...
                <div class="panel-body p-0"> 
                        ...
                        <div id="aboutme" class="tab-pane active">
                            <div class="box-layout meta bottom" >
                                <div class="col-sm-12 clearfix ">
                                    <div class="row">
                                        <div class="col-md-1">
                                            <span class="img-wrapper pull-left m-r-15" style="margin-top: 4px;">
                                                <img src="<?php echo URLROOT;?>/patient_photos/<?php echo $photo; ?>" alt="" style="width:64px; height: 65px!important;" class="br-radius">
                                            </span>
                                        </div>
                                        <div class="col-md-3">

                                            <h3 class="" style="margin-top: 10px;padding-top: 0px;"><?php echo ucwords($patient_name);?><span style="font-size: 14px;">(<?php echo $patient_id;?>)</span></h3>
                                            <h5 class="text">Age: 
                                            <?php 
                                                $curr_yr = date('Y-m-d');
                                                if($dob != "0000-00-00")
                                        ...
                                        <div class="col-md-8">
                                            <span style="float: right;"><a href="<?php echo URLROOT; ?>/admin/edit_patient/<?php echo $patient_id; ?>"><i class="fa fa-pencil" aria-hidden="true">&nbsp;&nbsp;</i><u>Edit Info</u></a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="user-activities" class="tab-pane">
                        ...
                        <div class="timeline-2">
                            <div class="time-item">
                                <div class="item-info">
                                    <div class="text-muted">Visited: <?php echo date('d-m-Y h:i A', strtotime($visit_date));?>
                                        
                                    </div>
                                    <p><strong>Doctor: <span class="text-info">Dr. <?php echo ucwords($doc_name);?></span></strong></p>
                                    <p><strong>Purpose: <span class="text-info"><?php echo ucwords($pur) ;?></span></strong></p>
                                    <a data-toggle="modal" href="#con-close-modal<?php echo $visit_id;?>" class="" style="font-size: 14px; color: #E67E22;">Know More →</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="con-close-modal<?php echo $visit_id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <?php
                                 $opd = new Admin;
                                 $opd_dat = $opd->get_all_opd_data($visit_id);
                                        ...
                                        <div class="modal-body"> 
                                            <div class="row"> 
                                                <div class="col-md-6"> 
                                                    ...
                                                    <label>Doctor Name: </label> Dr. <?php echo ucwords($doc_name);?><br>
                                                ...
                                                <div class="col-md-2"> 
                                                    <a href="<?php echo URLROOT;?>/admin/print_prescription/<?php echo $visit_id;?>"><button type="button" class="btn btn-success w-xs m-b-5"> Print </button></a><br>
                        ...
                        <?php } ?> <div><a style="color: orange;" href="<?php echo URLROOT; ?>/admin/print_invoice_for_all/<?php echo $p_id; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Print All Bill</a></div>
                    </div>
                        ...
                        <div class="timeline-2">
                            <div class="time-item">
                                <div class="item-info">
                                    ...
                                    <p><strong>Doctor: <a href="#" class="text-info">Dr. <?php echo ucwords($doct_name);?></a></strong></p>
                                    <a href="<?php echo URLROOT; ?>/admin/print_admit_medicines/<?php echo $ipd->ipd_admit_id; ?>"><button class="btn btn-purple btn-xs m-b-5">Print Medicine</button></a>
                                    <form action="<?php echo URLROOT; ?>/admin/discharge_summary" method="POST">
                                    ...
                                    <a href="<?php echo URLROOT; ?>/admin/print_invoice_for_all_ip/<?php echo $p_id; ?>"><button class="btn btn-purple btn-xs m-b-5">Print All Bill</button></a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
