    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <select class="form-control" style="float: right;width: 200px;" onchange="location = this.value;">
              <option value="<?php echo URLROOT; ?>/admin/all_orders" >Regular Orders</option>
              <option value="<?php echo URLROOT; ?>/admin/all_orders_lab" >Lab Orders</option>
              <option value="<?php echo URLROOT; ?>/admin/all_orders_bal" >Balance Orders</option>
            </select>
            <div class="" ><h3 class="panel-title">Regular All Orders</h3></div>
  ...
  $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/all_orders1',
                data: {lim,off},
                cache: false,
  ...
  $(document).ready(function(){
        $("#invoice_id_value").keyup(function(){
          ...
          if(inv!=0)
          {
            $.ajax({
              type:'POST',
              url:'<?php echo URLROOT;?>/admin/search_by_inv_id',
              data:{inv},
  ...
  $(document).ready(function(){
        $("#search_by_name_value").keyup(function(){
          ...
          if(patient_name!=0)
          {
            $.ajax({
              type:'POST',
              url:'<?php echo URLROOT;?>/admin/search_by_name_value',
              data:{patient_name},
              success : function(data)
              {
                $('#all_orders').html(data);
  ...
  $(document).ready(function(){
        $("#get_wrt_date").click(function(){
          ...
          if(start != '' && end != '')
          {
            $.ajax({
              type:'POST',
              url:'<?php echo URLROOT;?>/admin/get_all_orders_wrt_dates',
              data:{start, end},
              success : function(data)
              {
                $('#all_orders').html(data);
...
<script type="text/javascript">
  ...
  {
      $.ajax({
        url:'<?php echo URLROOT ?>/admin/undo_cancel',
        type:'POST',
        data:{id},
        success : function (data)
        {
