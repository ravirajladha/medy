		...
		<div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="col-md-12">
                        <input type="text" id="search_pat" name="" class="form-control" placeholder="Search Patient">
                    </div>
                </div>      
            </div>
            <div class="col-md-6">
          ...
          $(document).ready(function()
                  {
                    ...
                    var inc = 0;
                      $.ajax({
                        type: "POST",
                        url: '<?php echo URLROOT;?>/admin/patient_report_year',
          ...
          $(document).ready(function()
                  {
                    ...
                    var inc = 0;
                      $.ajax({
                        type: "POST",
                        url: '<?php echo URLROOT;?>/admin/patient_report_month',
  ...
  $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/patient_report',
                data: {lim,off,date},
                cache: false,
                success:function(response)
                {
  ...
  $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/patient_report_custom',
                data: {lim,off,to,frm},
                cache: false,
                success:function(response)
                {
