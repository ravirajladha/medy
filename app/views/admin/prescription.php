    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="row">
             ...
             <div class="col-sm-4">
                  <input type="text" id="pat_name" name="example-input2-group2" class="form-control" placeholder="Search By Patient Name" style="margin-top: 10px;">
             </div>
             <div class="col-sm-4">
                  <input type="number" id="pat_phone" name="example-input2-group2" class="form-control" placeholder="Search By Patient Phone" style="margin-top: 10px;">
             </div>
             </div>
             <br>
              <div class="row">
    ...
    $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/all_prescription',
                data: {lim,off},
                cache: false,
    ...
    $(document).ready(function()
          {
            $('#vis_id').keyup(function(){
              ...
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/prescription_search_by_id',
                data: {visit_id},
                cache: false,
                success:function(response)
                {
    ...
    $(document).ready(function()
          {
            $('#pat_name').keyup(function(){
              ...
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/prescription_search_by_name',
                data: {pat_name},
                cache: false, 
                success:function(response)
                {
    ...
    $(document).ready(function()
          {
            $('#pat_phone').keyup(function(){
              ...
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/prescription_search_by_phone',
                data: {pat_name},
                cache: false, 
                success:function(response)
                {
