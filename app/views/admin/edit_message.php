...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
            <div class="panel-heading"><?php if (isset($data['p_details'])) { ?><h3 class="panel-title">Update Patient</h3><?php } else { ?><h3 class="panel-title">Update Message</h3><?php } ?></div>
                <div class="panel-body">
				<div class="row" >
					<div class="col-md-3">
		                <div class="form-group">
							<label for="exampleInputEmail1">Message Content</label>
		                        <input style="margin-top: 10px;" type="text" class="form-control" id="p_name" placeholder="Enter Message Content" required="true" onkeypress="" value="<?php echo $data['msg_res']->message; ?>">

		                        <input type="number" id="message_id" value="<?php echo $data['message_id']; ?>" style="display: none;">
				    	</div>
					</div>
				...
				<div class="col-md-2">
		            <div class="form-group">
		            	...
		            	<?php } else { ?>
					   <button style="margin-top: 34px" type="button" class="btn btn-info w-md m-b-5" onclick="patient_details()">Update Message</button>
						<?php } ?>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function patient_details()
	{
		...
		var message_id = $('#message_id').val();
        			...
        			$.ajax({
        			url:'<?php echo URLROOT;?>/admin/update_message_admin',
        			type:'POST',
        			data:{p_name, message_id},
