    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <select class="form-control" style="float: right;width: 200px;" onchange="location = this.value;">
              ...
              <option value="<?php echo URLROOT; ?>/admin/all_orders_bal" selected="">Balance Orders</option>
            </select>
            <div class="" ><h3 class="panel-title">Balance All Orders</h3></div>
  ...
  $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/receptions/all_orders_bal1',
                data: {lim,off},
                cache: false,
