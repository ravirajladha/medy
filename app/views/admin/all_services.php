  ...
  $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/all_services1',
                data: {lim,off},
                cache: false,
  ...
  $(document).ready(function(){
        $("#service_id_value").keyup(function(){
          ...
          if(inv!=0)
          {
            $.ajax({
              type:'POST',
              url:'<?php echo URLROOT;?>/admin/search_by_ser_id',
              data:{inv},
  ...
  $(document).ready(function(){
        $("#search_by_name_value").keyup(function(){
          ...
          if(patient_name!=0)
          {
            $.ajax({
              type:'POST',
              url:'<?php echo URLROOT;?>/admin/search_by_service_name',
              data:{patient_name},
              success : function(data)
              {
                $('#all_services').html(data);
  ...
  $(document).ready(function()
          {
            $(document).on('click', 'button[data-id]', function () {
                ...
                $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/admin/delete_service',
                data: {ser_id,ser_id},
                cache: false,
                success:function(response)
                {
