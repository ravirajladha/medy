...
<?php
        ...
        {
            $ppid = $pp->invoice_name;
        }

        $rec_obj = new Admin;
        $pat_data = $rec_obj->get_patients_data_to_print_old($ppid);
        ...
        foreach ($data['last_inv'] as $key)
        {
            ...
            $inv_item_len = sizeof($inv_item)/3;
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                            ...
                                            <table class="table m-t-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php
                                                                    echo $rec_obj->getServiceName($inv_item[($t*3)+0]);
                                                        ?></td>
                                                        <td style="text-align: left; padding-left: 50px;"><?php echo $inv_item[($t*3)+1];?></td>
                                                        <td>&nbsp;<?php echo $inv_item[($t*3)+2];?></td>
                                                    </tr>
                                                <?php } ?> 
                                                </tbody>
                                            </table>
                                ...
                                <div class="row" style="border-radius: 0px;">
                                    <div class="col-md-3 col-md-offset-9">
                                        ...
                                        <p class="text-right" style="padding-right: 7px;"><b>
                                            <?php if($dis != NULL) { ?>
                                            Discount:</b> &nbsp;&nbsp;₹ <?php echo $dis; } ?>
                                        </p>
                                         <p class="text-right" style="padding-right: 7px;"><b>Total amount paid:</b> &nbsp;&nbsp;₹ <?php echo $key->invoice_bill - $dis; ?>
                                        </p>
                                        <hr>
                                        <h3 class="text-right">₹ <?php echo $invoice_total - $dis;?>.00</h3>
                                    </div>
                                </div>
                                <?php 
                                    $i++;
                                ...
                                <div class="hidden-print">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?php echo URLROOT;?>/admin/print_invoice_old/<?php echo $invoice_id;?>" class="btn btn-success"><i class="fa fa-print"></i> &nbsp;Print</a>
                                    </div>
                                </div>
                            </div>
                        </div>
