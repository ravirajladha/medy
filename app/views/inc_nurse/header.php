      ...
      .head_sty:hover
      {
        ...
        <aside class="left-panel">
            ...
            <div class="logo" id="myDIV">
                <a href="<?php echo URLROOT;?>/nurses/index" style="padding-left: 25px;">
            ...
            <div class="logo" id="myDI" style="display: none;">
                <a href="<?php echo URLROOT;?>/nurses/index" class="">
            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/nurses/index"><i class="ion-home"></i> <span class="nav-label">Dashboard</span></a>
                    </li>
                    <li class="has-submenu"><a href="#"><i class="ion-flask"></i> <span class="nav-label">View Patients</span></a>
                        <ul class="list-unstyled">
                            ...
                            <li><a href="<?php echo URLROOT;?>/nurses/admits">Admissions</a></li>
                        </ul>
                    </li>
                    <li class="has-submenu"><a href="#"><i class="ion-compose"></i> <span class="nav-label">My Services</span></a>
                        <ul class="list-unstyled">
                            <li><a href="<?php echo URLROOT;?>/nurses/myvisits">Visit Services</a></li>
                            <li><a href="<?php echo URLROOT;?>/nurses/myadmits">Admit Services</a></li>
                        </ul>
                    </li>
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/nurses/operations"><i class="ion-heart"></i> <span class="nav-label">Operations</span></a>
                    </li>
                </ul>
            </nav>         
        </aside>
                ...
                <ul class="list-inline navbar-right top-menu top-right-menu">  
                    ...
                    <li class="dropdown text-center">
                        ...
                        <ul class="dropdown-menu extended pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                            ...
                            <li><a href="<?php echo URLROOT;?>/nurses/settings"><i class="fa fa-cog"></i> Settings</a></li>
  ...
  <script type="text/javascript">
     $(document).ready(function(){
      $('#patient_name_list').keyup(function(){
        ...
        {
          $.ajax({
            url:'<?php echo URLROOT;?>/nurses/get_auto_patient_name_for_header',
            type:'POST',
            data:{query3:query3}, 
       ...
       $(document).on('click', '.head_sty', function(){
           ...
           p[1] = p[1].replace(/[{()}]/g, "");
           r = p[1].trim();
           window.location.href = "<?php echo URLROOT;?>/nurses/view_profile_patient/"+r+"";
           $('#pat_list_div').fadeOut();  
      });
