      ...
      .head_sty:hover
      {
        ...
        <aside class="left-panel">
            ...
            <div class="logo" id="myDIV">
                <a href="<?php echo URLROOT;?>/ot/index" style="padding-left: 25px;">
            ...
            <div class="logo" id="myDI" style="display: none;">
                <a href="<?php echo URLROOT;?>/ot/index" class="">
            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/ot/index"><i class="ion-home"></i> <span class="nav-label">Dashboard</span></a>
                    </li>
                     <li class="has-submenu"><a href="#"><i class="ion-ios7-pulse-strong"></i> <span class="nav-label">Operations</span></a>
                        <ul class="list-unstyled">
                            <li><a href="<?php echo URLROOT;?>/ot/new_operation">New Operation</a></li>
                            <li><a href="<?php echo URLROOT;?>/ot/current_operation">Current Operation</a></li>
                            <li><a href="<?php echo URLROOT;?>/ot/active_operation">Active Operation</a></li>
                            <li><a href="<?php echo URLROOT;?>/ot/completed_operation">Completed Operation</a></li>
                            <li><a href="<?php echo URLROOT;?>/ot/canceled_operation">Canceled Operation</a></li>
                        </ul>
                    </li>
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/ot/record_operation"><i class="fa fa-database"></i> <span class="nav-label">Reports</span></a>
                    </li>
                    <li class="has-submenu"><a href="#"><i class="ion-scissors"></i> <span class="nav-label">Operation Assets</span></a>
                        <ul class="list-unstyled">
                            <li><a href="<?php echo URLROOT;?>/ot/addAssets">Add Asset</a></li>
                            <li><a href="<?php echo URLROOT;?>/ot/allAssets">All Assets</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>         
                ...
                <ul class="list-inline navbar-right top-menu top-right-menu">  
                    ...
                    <li class="dropdown text-center">
                        ...
                        <ul class="dropdown-menu extended pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                            ...
                            <li><a href="<?php echo URLROOT;?>/ot/settings"><i class="fa fa-cog"></i> Settings</a></li>
