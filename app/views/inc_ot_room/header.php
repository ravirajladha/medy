      ...
      .head_sty:hover
      {
        ...
        <aside class="left-panel">
            ...
            <div class="logo" id="myDIV">
                <a href="<?php echo URLROOT;?>/ot_room/index" style="padding-left: 25px;">
            ...
            <div class="logo" id="myDI" style="display: none;">
                <a href="<?php echo URLROOT;?>/ot_room/index" class="">
            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/ot_room/index"><i class="ion-home"></i> <span class="nav-label">Dashboard</span></a>
                    </li>
                    <li class="has-submenu"><a href="#"><i class="ion-ios7-pulse-strong"></i> <span class="nav-label">Hospital Rooms</span></a>
                        <ul class="list-unstyled">
                            <li><a href="<?php echo URLROOT;?>/ot_room/create_rooms">Create Rooms</a></li>
                            <li><a href="<?php echo URLROOT;?>/ot_room/allocated_rooms">Allocated  Rooms </a></li>
                            <li><a href="<?php echo URLROOT;?>/ot_room/available_rooms">Available Rooms</a></li>
                           <li><a href="<?php echo URLROOT;?>/ot_room/canceled_rooms">Canceled Rooms</a></li>
                        </ul>
                    </li>
                    <li class="has-submenu"><a href="#"><i class="fa fa-bed" aria-hidden="true"></i><span class="nav-label">Hospital Bed</span></a>
                        <ul class="list-unstyled">
                            <li><a href="<?php echo URLROOT;?>/ot_room/create_bed">Create Bed</a></li>
                            <li><a href="<?php echo URLROOT;?>/ot_room/allocated_bed">Allocated Bed</a></li>
                        </ul>
                    </li>
                    <li class="has-submenu"><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i><span class="nav-label">Bookings</span></a>
                        <ul class="list-unstyled">
                            <li><a href="<?php echo URLROOT;?>/ot_room/bookings">New Booking</a></li>
                            <li><a href="<?php echo URLROOT;?>/ot_room/allBookings">All Bookings</a></li>
                        </ul>
                    </li>
                    </li>
                </ul>
                ...
                <ul class="list-inline navbar-right top-menu top-right-menu">  
                    ...
                    <li class="dropdown text-center">
                        ...
                        <ul class="dropdown-menu extended pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                            ...
                            <li><a href="<?php echo URLROOT;?>/ot_room/settings"><i class="fa fa-cog"></i> Settings</a></li>
