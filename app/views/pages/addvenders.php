<?php require APPROOT . '/views/inc/header.php'; ?>
            ...
            <div class="contentbar">
                <!-- Start row -->
                <form action="<?php echo URLROOT; ?>/pages/saveTheVendorDetails" method="POST">
                <div class="row">
                    <!-- Start col -->
                    <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label >Company Name</label>
                                         <input type="text" class="form-control" placeholder="" name="compName">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="dispName">
                                    </div>
                        ...
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="" name="venEmail">
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                <input type="number" class="form-control" placeholder="Home" name="vendPhoneHome">
                                             </div>
                                             <div class="col-md-6 form-group">
                                                 <input type="number" class="form-control" placeholder="Work" name="vendPhoneWork">
                                             </div>
                                         </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label >Website</label>
                                        <input type="text" class="form-control" name="vendWeb">
                                    </div>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Currency" name="vendCurrency">
                                       
                                    </div>
                                      <div class="form-group">
                                        <label >Payment Terms</label>
                                        <input type="text" class="form-control" placeholder="Payment Terms" name="vendPayment">
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label >Twitter</label>
                                        <input type="text" class="form-control" placeholder="Twitter" name="twittetr">
                            ...
                            <div class="card-body">
                                <label> Billing Address</label>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="attension">
                                   ...
                                   <div class="form-group">
                                        <label >Phone</label>
                                        <input type="text" class="form-control" placeholder="" name="phoneAdd">
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <label> Shipping Address &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;  </label>
                                    ...
                                    <div class="form-group">
                                        <label >Address</label>
                                        <textarea class="form-control" placeholder="street1"></textarea>
                                        <br>
                                        <textarea class="form-control"  placeholder="street2"></textarea>
                                        ...
                                        <tbody>
                                          <tr>
                                              <td><select class="form-control" id="formControlSelect" name="contSalu">
                                                ...
                                                <td><input type="text" class="form-control" name="contFirstname"></td>
                                                <td><input type="text" name="contLastName" class="form-control" ></td>
                                                <td><input type="text" name="contEmail" class="form-control"></td>
                                                <td><input type="text" name="contWorkPhone" class="form-control"></td>
                                                <td><input type="text" name="contWorkMobile" class="form-control"></td>
