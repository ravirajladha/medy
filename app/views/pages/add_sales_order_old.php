...
<div class="breadcrumbbar">
	<div class="row align-items-center">
		<div class="col-md-8 col-lg-8">
			<h4 class="page-title">New Sales Order</h4>
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<select name="" id="stateSelect" class="form-control">
								...
								<option value="2" selected>Outside State</option>
							</select>
						</div>
					</div>
				</div>
				...
				<div class="card m-b-30">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input type="date" class="form-control" placeholder="" name="ndate">
						</div>
						<div class="form-group">
							<label>Expected Shipment Date</label>
							<input type="date" class="form-control" placeholder="" name="expected_delivery_date">
						</div>
						<div class="form-group">
								...
								<table class="table table-bordered table-hover" id="tab_logic">
									...
									<tbody id='addr1'>
										<tr id='addr0'>
											...
											<td><input type="number" name='qty[]' placeholder='Enter Qty' class="form-control qty" step="0" min="0" onchange="calculateTheGst(this.value)" id="qty"/></td>
									...
									<input type="text" id="temp_check" name="">
								</table>
							</div>
						</div>
						<div class="row clearfix">
...
<script>
	$('#tags').keyup(function() {
		...
		if (searchedName.length > 2) {
			...
			$.ajax({
				url: '<?php echo URLROOT; ?>/doctors/getTheDoctorAjax',
				type: "POST",
				data: {
					searchedName,
					location
