...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-lg-11">
             <h4 class="page-title">Datewise Customers Sales Report</h4>
            ...
            <div class="card m-b-30">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <center>
                                ...
                                <h5 class="card-title mb-0" style="font-size: 28px;">Datewise Customers Sales Report</h5>
                                <br>
                            </center>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <center>
                        ...
                        <form action="<?php echo URLROOT ;?>/pages/customerwise_sales_report2_time2" method="POST" id="customer_form">
