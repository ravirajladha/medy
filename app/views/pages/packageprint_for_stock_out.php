...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Sales Order - Package/Shipment</h4>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                    <a href="http://bharathielectricals.com/be/barcode/index1.php?ids=<?php echo $data['stock_out']->stock_out_id; ?>&color=<?php echo $data['p_stockout']->st_id; ?>&size=null&length=null" class="btn btn-info text-white" target="_blank"><i class="fa fa-qrcode" aria-hidden="true"></i></a>
            </div>                        
        </div>
    </div>
</div>
                        ...
                        <div class="invoice-head">
                            <div class="row">
                                <div class="col-12 col-md-7 col-lg-7">
                                    ...
                                    <?php if($data['p_stockout']->status==1){ ?>
                                    <h2 class="text-uppercase mb-3">Packed</h2>
                                    <?php }elseif($data['p_stockout']->status==2){?>
                                      <h2 class="text-uppercase mb-3">Shipped</h2>  
                                  <?php }elseif($data['p_stockout']->status==3){?>
                                      <h2 class="text-uppercase mb-3">Delivered</h2>  
                                  <?php }?>

                                    <p class="mb-1">Package/Shipment No: <?php echo $data['p_stockout']->st_id; ?></p>
                                    <h4></h4>
                                </div>
                                <div class="col-12 col-md-5 col-lg-5">
                                    <div class="invoice-name">
                                        ...
                                        <p class="mb-1">No : <?php echo $data['stock_out']->stock_out_id; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive ">
                                <table class="table">
                                    ...
                                    <?php
                                        $item_t_total=0;
                                        $t_tax = 0;
                                        $itemId = explode('|||', $data['p_stockout']->item_id);
                                        $itemName = explode('|||', $data['p_stockout']->item_name);
                                        $itemQty = explode('|||', $data['p_stockout']->item_packed);
