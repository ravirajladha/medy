                        ...
                        <div class="invoice-head">
                            <div class="row">
                                <div class="col-12 col-md-7 col-lg-7">
                                    ...
                                    <?php if($data['p_sales']->status==1){ ?>
                                    <h2 class="text-uppercase mb-3">Packed</h2>
                                    <?php }elseif($data['p_sales']->status==2){?>
                                      <h2 class="text-uppercase mb-3">Shipped</h2>  
                                  <?php }elseif($data['p_sales']->status==3){?>
                                      <h2 class="text-uppercase mb-3">Delivered</h2>  
                                  <?php }?>

                                    <p class="mb-1">Package/Shipment No: <?php echo $data['p_sales']->sp_id; ?></p>
                            ...
                            <div class="table-responsive ">
                                <table class="table">
                                    ...
                                    <?php
                                        ...
                                        $itemQty = explode('|||', $data['p_sales']->item_packed);
                                    ...
                                    <div class="order-total table-responsive ">
                                        <table class="table table-borderless text-right">
                                            <tbody>
                                                ...
                                                <?php
                                                $ship =0;
                                                 if($data['p_sales']->status==2){?>
                                                    <tr>
                                                        <td class="f-w-7 font-14">
                                                            <h6>Shipping Cost:</h6>
                                                        </td>
                                                        <td class="f-w-7 font-14">
                                                            <h5>₹ <?php echo $data['p_sales']->shipping_charges; $ship=$data['p_sales']->shipping_charges; ?></h5>
                                                        </td>
                                                    </tr>
                                                <?php }?>
                                                <tr>
