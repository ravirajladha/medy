  ...
  <!-- Start Breadcrumbbar -->                    
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-lg-11">
                        <h4 class="page-title">Sales order pending report</h4>
                            ...
                            <div class="card-header">                                
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        ...
                                        <h5 class="card-title mb-0" style="font-size: 28px;">Sales order pending report</h5>
                                        <br>
                                                        ...
                                                        <select name="modelid" id="modelid" class="form-control" onchange="newmod(this.value)">
                                                            <option selected="" disabled="">--select--</option>
                                                                ...
                                                                <?php foreach ($data['mod'] as $key) {
                                                                    ...
                                                                    $post = new Page();
                                                                    $modelid= $post->get_single_model1($key->model_name);?>
  ...
  function get_all_category_search()
    {
        ...
        var sort = $('#modelid').val();
          ...
          $.ajax({
            type:'POST',
            url:'<?php echo URLROOT;?>/pages/by_allcategory_item_cat9',
            data:{sort},
