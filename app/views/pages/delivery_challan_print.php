...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Delivery Challan Invoice</h4>
                        ...
                        <div class="invoice-head">
                            <div class="row">
                                <div class="col-12 col-md-7 col-lg-7">
                                    ...
                                    <h5 class="text-uppercase mb-3">Delivery Challan</h5>
                                        <p class="mb-1">No : <?php echo $data['sales']->delivery_challan_order_id; ?></p>
                                ...
                                <div class="col-12 col-md-5 col-lg-5">
                                    <div class="invoice-name">
                                        ...
                                        <p class="mb-1">No : <?php echo $data['sales']->delivery_challan_id; ?></p>
