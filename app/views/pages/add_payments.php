                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                       ...
                                       <input type="text" name=""  class="form-control" placeholder="Petty Cash">
                                       <br>
                           ...
                           <div class="row clearfix" style="margin-top:20px;float: right;">
                            ...
                            <div class="pull-right col-md-12" style="margin-top: 30px;">
                              <table class="table table-bordered table-hover" id="tab_logic_total">
                               ...
                               <a href="<?php echo URLROOT;?>/pages/all_payments"><button class="btn btn-primary" style="float: right; margin-left: 10px;">Cancle</button></a>
                                <a href="<?php echo URLROOT;?>/pages/all_payments">
