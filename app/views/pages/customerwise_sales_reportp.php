  ...
  <!-- Start Breadcrumbbar -->                    
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-lg-11">
                        <h4 class="page-title">Customer Wise Direct Package Report</h4>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        <center>
                                            ...
                                            <h5 class="card-title mb-0" style="font-size: 28px;">Customer Wise Direct Package Report</h5>
                                            <br>
                                        </center>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                $st = $Page->get_all_direct_pack_by_custid($key->customer_id); 
                                                ?>
                                                <td style="border-bottom: 1px solid black">
                                                    <?php foreach ($st as $k) 
                                                    { 
                                                        echo date("d-m-Y",strtotime($k->pack_date));
                                                        break;
                                                    }
                                                    ?>
