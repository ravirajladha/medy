...
<div class="breadcrumbbar">
	<div class="row align-items-center">
		<div class="col-md-8 col-lg-8">
			<h4 class="page-title">New Purchase Order</h4>
...
<!-- Start Contentbar -->
	...
	<div class="contentbar">
		...
		<!-- Start row -->
		<form method="POST" action="<?php echo URLROOT; ?>/pages/create_purchase_order" enctype="multipart/form-data" id="formId">
		<div class="row">
			<!-- Start col -->
				...
				<div class="card m-b-30">
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" name="vendor_id" id="vname_id" style="display: none;" />
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="deliver_to"><?php echo $caddress; ?></textarea>
						</div>

						<div class="form-group" style="display: none;">
							<label>Purchase Order#</label>
							<input type="text" class="form-control" placeholder="ex P0-00001" name="purchase_order">
						</div>
						<div class="form-group">
									...
									<tbody id="addr1">
										<tr id='addr0'>
											...
											<td width="400">
												...
												<input type="text" name='product' placeholder='Enter Item Name' class="form-control" id="tags1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" autocomplete="off"/ style="display: none;">
											...
											<td>
												<!-- <input type="text" class="form-control" name="receivable" id="receivable" readonly> -->
											...
											<td><input type="number" name='perUnit' placeholder='Enter Per Unit Quantity' class="form-control" id="perUnit" value="1" onchange="changeTotalQty()"/></td>

											<td><input type="number" name='actQty' placeholder='Enter Quantity' class="form-control" id="actQty" onkeyup="changeTotalQty()"/></td>
											<td style="display: none;"><input type="number" name='qty' placeholder='Total Qty' class="form-control qty" step="0" min="0" id="ttlq" /></td>

											<td><input type="number" name='price' placeholder='Enter Unit Price' class="form-control price" step="0.00" min="0" id="rowPrice"/></td>
											<td><input type="number" name='total' placeholder='0.00' class="form-control total" id="rowTotal" readonly /></td>
										</tr>
									</tbody>
								</table>
							</div>
