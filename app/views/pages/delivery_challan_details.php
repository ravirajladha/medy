            ...
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-7">
                        <h4 class="page-title">Delivery Challan Details</h4>
                            ...
                            <div class="card-header">                                
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        ...
                                        <h5 class="card-title mb-0" style="font-size: 28px;">Delivery Challan Details</h5>
                                        <br>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>10-07-2020</td>
                                                 <td>Delivered</td>
                                                <td>Not Invoiced</td>
                                                <td>sri sri publications trust</td>
                                                <td>Rs.850.00</td>
