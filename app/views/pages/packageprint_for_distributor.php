...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Distributor Package/Shipment invoice</h4>
                        ...
                        <div class="invoice-head">
                            <div class="row">
                                <div class="col-12 col-md-7 col-lg-7">
                                    ...
                                    <?php if($data['p_distributor']->status==1){ ?>
                                    <h2 class="text-uppercase mb-3">Packed</h2>
                                    <?php }elseif($data['p_distributor']->status==2){?>
                                      <h2 class="text-uppercase mb-3">Shipped</h2>  
                                  <?php }elseif($data['p_distributor']->status==3){?>
                                      <h2 class="text-uppercase mb-3">Delivered</h2>  
                                  <?php }?>

                                    <p class="mb-1">Package/Shipment No: <?php echo $data['p_distributor']->dp_id; ?></p>
                                ...
                                <div class="col-12 col-md-5 col-lg-5">
                                    <div class="invoice-name">
                                        ...
                                        <p class="mb-1">No : <?php echo $data['distributor']->distributor_id; ?></p>
                            ...
                            <div class="table-responsive ">
                                <table class="table">
                                    ...
                                    <?php
                                        $item_t_total=0;
                                        $t_tax = 0;
                                        $itemId = explode('|||', $data['distributor']->item_id);
                                        $itemName = explode('|||', $data['distributor']->item_name);
                                        $itemQty = explode('|||', $data['p_distributor']->item_packed);
                                        $itemPrice = explode('|||', $data['distributor']->item_price);
                                        $itemTax = explode('|||', $data['distributor']->item_tax);
                                        $itemTotal = explode('|||', $data['distributor']->item_total);
                                        $itemState = explode('|||', $data['distributor']->item_state);
                                    ?>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $itemPrice[$i] * $itemQty[$i]; 
                                    ...
                                    <div class="order-total table-responsive ">
                                        <table class="table table-borderless text-right">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="f-w-7 font-14">
                                                        <h6>Sub Total:</h6>
                                                    </td>
                                                    <td class="f-w-7 font-14">
                                                        <h5>₹ <?php echo array_sum($itemTotal); ?></h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="f-w-7 font-14">
                                                    ...
                                                    <td class="f-w-7 font-14">
                                                        <h5>₹ <?php echo $t_tax; ?></h5>
                                                    </td>
                                                </tr>
                                                <?php
                                                $ship =0;
                                                 if($data['p_distributor']->status==2){?>
                                                    <tr>
                                                        <td class="f-w-7 font-14">
                                                            <h6>Shipping Cost:</h6>
                                                        </td>
                                                        <td class="f-w-7 font-14">
                                                            <h5>₹ <?php echo $data['p_distributor']->shipping_charges; $ship=$data['p_distributor']->shipping_charges; ?></h5>
                                                        </td>
                                                    </tr>
                                                <?php }?>
                                                <tr>
                                                    ...
                                                    <td class="f-w-7 font-18">
                                                        <h5>₹ <?php echo $t_tax + $item_t_total+$ship; ?></h5>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
