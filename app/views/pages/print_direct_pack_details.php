...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Direct Package Order Details</h4>
                            ...
                            <ul class="list-inline-group text-right mb-0 pl-0" >
                                <li class="list-inline-item">
                                        <div class="form-group mb-0 amount-spent-select" style="text-align: left;">
                                            <h4 class="mb-0">Direct Package Order</h4>
                                        <label>Order NO: <?php echo $b->p_id;?></label>
                                        <?php $Page = new Page(); ?>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 pl-0">
                            ...
                            <label>Date:<?php echo $b->pack_date;?></label>
                            <br>
