...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Distributor Order Package Shipment</h4>
...
<div class="contentbar">
    <div class="row">
        <form action="<?php echo URLROOT; ?>/pages/shipmentCreate_for_dist/<?php echo $data['dp_id'];?>" method="POST">
        <div class="col-md-12">
            <div class="card m-b-30">
                <div class="card-header bg-primary-rgba">
                    <h5 class="card-title text-primary">Distributor Order ID - <?php echo $data['id'] ?></h5>
                </div>
                <br>
