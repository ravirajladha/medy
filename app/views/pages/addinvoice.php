                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                     ...
                                     <div class="form-group">
                                        <label >Invoice#</label>
                                        <input type="text" class="form-control" placeholder="INV-000002">
                                    </div>
                        ...
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                    ...
                                    <a href="<?php echo URLROOT;?>/pages/sales_order"><button class="btn btn-primary" style="float: right; margin-left: 10px;">Cancle</button></a>
                                     <a href="<?php echo URLROOT;?>/pages/sales_order"><button class="btn btn-primary" style="float: right;">Submit</button></a>
                                     </div>
