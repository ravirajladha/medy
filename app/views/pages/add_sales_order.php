...
<div class="breadcrumbbar">
	<div class="row align-items-center">
		<div class="col-md-8 col-lg-8">
			<h4 class="page-title">New Sales Invoice</h4>
...
<!-- End Breadcrumbbar -->
<!-- Start Contentbar -->
<form method="POST" action="<?php echo URLROOT; ?>/pages/create_sales_order" enctype="multipart/form-data" id="salesForm">
				...
				<div class="card m-b-30">
					...
					<div class="card-body">
										...
										<tr id='addr0'>
											...
											<td width="400">
												...
												<select class="select2-single form-control" name='' id="tags" onchange="getitem_name(this.value)">
                                                    ...
                                                    $m = $d->get_model_name_by_id($it->model_id);
											...
											<td width="150"><input type="number" name='qty' placeholder='Enter Qty' class="form-control qty" step="0" min="0" onclick="calculateTheGst(this.value)" id="qty" value="" /></td>
											<td width="150"><input type="number" name='price' placeholder='Enter Unit Price' class="form-control price" id="price" step="0.00" min="0" /></td>
											<td id="gst" width="100" onchange="changetaxpercent()">

											</td>
											<td width="150"><input type="number" name='total' placeholder='0.00' class="form-control total" id="totalRow" readonly /></td>
										</tr>
									</tbody>
						...
						<div class="row clearfix" style="margin-top:20px;float: right;">
							<div class="pull-right col-md-6" style="margin-top: 30px; display: none; ">
...
<script type="text/javascript">
	...
	function calc_total() {
		...
		$('#tax_amount').val(parseInt($('#tax').val())+ parseInt(mtax));
		t=0;
		t = $('#tax').val();
		total = parseInt(total);
		t = parseInt(t);
		$('#total_amount').val(total+t+mtax);
		// calc_tax_total();
	...
	function calc_total1()
	{
		...
		$('#tax_amount').val(t.toFixed(2));
		$('#discount_amount').val(discount);
		$('#total_amount').val((t+total-discount).toFixed(2));
	}
...
<script>
	...
	function addRowForBill()
	{
		...
		{
			mtax = parseInt(mtax) + parseInt($('#tax').val());
