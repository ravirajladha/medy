        ...
        <div class="col-md-8 col-lg-8">
            ...
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo URLROOT;?>/assets/pages/index">Customer Wise Sales Report</a></li>
            ...
            <div class="card m-b-30">
                <div class="container">
                 <br>
                    ...
                    <h3 style='text-align: center;' class="mb-3">Customer Wise Wires Sales Report</h3>

                    <center><select name="year1" id="cutomer_id" onChange="yearChangeHandler" class=" mb-4" >

                                <option disabled selected="" style="color: white;">--SELECT A CUSTOMER---</option>
                                <?php

                                $customer_id = $data['customer_id'];

                                foreach ($data['get_distinct_stock_out'] as $key_cu)
                                {
                                ?>
                                <option value="<?php echo $key_cu->customer_id; ?>">
                                    <?php

                                    $cn = $d->get_customer_namefordisplay($key_cu->customer_id);

                                    echo $cn->customer_display_name;
                            ...
                            <select name="year" id="mySelect" onChange="yearChangeHandler" class="mb-4 ml-3">
                                ...
                                ?> 
                                    ...
                                    <span class="mb-5" style="margin-bottom: 10px;">
                                         <b>Customer Name:</b>
                                    </span>
                                    <?php
                                        $cn = $d->get_customer_namefordisplay($key_cu->customer_id);
                                                ...
                                                <tr>
                                                    ...
                                                    for($s = 1; $s <= sizeof($aa1); $s++)
                                                    {
                                                        ...
                                                        foreach ($get_fistColVal as $key)
                                                        {
                                                            ...
                                                            $get_from_sales_temp_boxes = $d->get_from_sales_temp_boxes($key->id, $customer_id);

                                                            $get_from_sales_temp_peices = $d->get_from_sales_temp_peices($key->id, $customer_id);

                                                            if(empty($get_from_sales_temp_boxes))
                                                            {
                                                                $stock_count_boxes+= 0;
                                                            }
                                                            else
                                                            {
                                                               foreach ($get_from_sales_temp_boxes as $key_sa)
                                                                {
                                                                   $stock_count_boxes+= $key_sa->item_qty;
                                                                } 
                                                            }

                                                            if(empty($get_from_sales_temp_peices))
                                                            {
                                                                $stock_count_pieces+= 0;
                                                            }
                                                            else
                                                            {
                                                               foreach ($get_from_sales_temp_peices as $key_pi)
                                                                {
                                                                   $stock_count_pieces+= $key_pi->item_qty;
                                                                } 
                                                            }                                                            
                                                        ...
                                                        ?>
                                                        <td align="center">B (<?php echo $stock_count_boxes; ?>)
                                                         <br>
                                                    ...
                                                    ?>
                                                     ...
                                                     <td style="font-weight: 520;" align="center">
                                                        B (<?php echo $sum_boxes; ?>)
                                                        <br>
...
<script type="text/javascript">
    ...
    { 
        var model_val = $("#mySelect").val();

        // var cutomer_id = 0;

        var cutomer_id = $("#cutomer_id").val();
        ...
        {
            window.location.href = '<?php echo URLROOT;?>/pages/del/'+ model_val +"|"+cutomer_id;
            // alert(value +"|"+cutomer_id);
        }
