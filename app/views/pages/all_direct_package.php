...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">All Direct Package</h4>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?php echo URLROOT; ?>/pages/stock_out"><button class="btn btn-primary">New</button>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="card-title mb-0">All Direct Package</h5>
                        </div>
                        <div class="col-6">
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id="processSaleModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleLargeModalLabel">Stock Out Order - <span id="pid"></span></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="tab-content" id="pills-tab-justifiedContent">
                    <ul class="nav nav-tabs nav-justified mb-3" id="pills-tab-justified" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-profile-tab-justified" data-toggle="pill" href="#pills-profile-justified" role="tab" aria-controls="pills-profile" aria-selected="false">Package</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-pane fade show active" id="pills-profile-justified" role="tabpanel" aria-labelledby="pills-profile-tab-justified">
...
<script type="text/javascript">
  $(document).ready(function()
    ...
    var inc = 0;
        $.ajax({
        type: "POST",
        url: '<?php echo URLROOT;?>/pages/getAlldirectpack_out',
        data: {lim,off},
        cache: false,
...
<script>
    function processModal(id)
    {
        ...
        $('#pid').text(id);
          $('#buttonArea').html('<a href="<?php echo URLROOT ?>/pages/packageCreate_for_stockout/'+id+'"><button type="button" class="btn btn-info-rgba">Create Package</button></a><a href="<?php echo URLROOT ?>/pages/makesales_bill/'+id+'"><button type="button" class="btn btn-info-rgba">Make Bill</button></a>');
        ...
        $.ajax({
            url: "<?php echo URLROOT; ?>/pages/processCreate_stock_out",
            type: "POST",
            data: {
                id
            },
        ...
        $.ajax({
            url: "<?php echo URLROOT; ?>/pages/createInvoice_for_stock_out",
            type: "POST",
            data: {
                id
            },
    ...
    {
        $.ajax({
            url: "<?php echo URLROOT; ?>/pages/updateShipment_for_stock_out",
            type: "POST",
            data: {
                sId
            },
