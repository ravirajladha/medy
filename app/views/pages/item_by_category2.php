                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row ">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label >Type</label>
                                                        <select name="type_id" id="type_id" class="form-control" onchange="categoryChange411(this.value)">
                                                            <option selected="" disabled="">--select--</option>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-1">
                                                <form action="<?php echo URLROOT;?>/pages/print_items_by_category_wise2" method="POST">
  ...
  function get_all_category_search()
    {
        ...
        if(category_id!=0)
        {
          $.ajax({
            type:'POST',
            url:'<?php echo URLROOT;?>/pages/by_allcategory_item_cat3',
