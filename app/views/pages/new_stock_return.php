                        ...
                        <div class="card m-b-30">
                            <div class="card-header">                                
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        <center>
                                            <h5 class="card-title mb-0" style="font-size: 28px;">Sales Return</h5>
                                            <br>                                     
                                        </center>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label></label>
                                                        <div class="form-group">
                                                            <a class="btn btn-info pull-left text-white" id="scstart" onclick="startscan()">Scan Items</a>
                                                            <a class="btn btn-warning pull-left text-white" id="scend" onclick="endscan()" style="display: none;">End Scan Items</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <label></label>
                                ...
                                {   
                                        ...
                                        var interval = setInterval(function()
                                        {
                                            ...
                                            if(y!="")
                                            {
                                                ...
                                                $.ajax({
                                                    type:"POST",
                                                    url: "<?php echo URLROOT; ?>/pages/scanQRforsales_return",
                                                    data:{barcode},
                            ...
                            <div class="card-body">
                                <form method="post" action="<?php echo URLROOT;?>/pages/return_listed_tems">
                                    <div class="table-responsive">
                                        <table class="table table-border" id="allItems">

                                        </table>
                                    </div>
                                    <button style="float: right;" class="btn btn-primary">Return</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
 ...
 function all_temp_scan_table() {
        $.ajax({
        type: "POST",
        url: '<?php echo URLROOT;?>/pages/getscaneditemssales_return',
        data: {},
        success:function(response)
        {
            $('#allItems').html(response);
