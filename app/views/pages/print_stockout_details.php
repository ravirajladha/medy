            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="col-md-4">
                            <label>Customer Name: <?php echo ucwords($b->customer);?></label>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="col-md-4 pl-0">
                            ...
                            <label>Date:<?php echo $b->stock_dt;?></label>
                            <br>
                                    ...
                                    <?php for ($h=0; $h < sizeof($item_id); $h++) 
                                      { ?>
                                        <tr>
                                            ...
                                            <?php $item_name1 = $Page->getTheItemDetails($item_id[$h]); 
                                            ?>
                                            <?php $mm = $Page->get_model_name_by_id($item_name1->model_id); ?>
                                            <td><?php echo "(".$mm->model_name.")".$item_name[$h];?></td>
                                            <td><?php
                                            if($receivable[$h]==1)
                                            {
                                                echo 'Box';
                    ...
                    <div class="row" style="display: none;">
                        ...
                        <div class="col-md-3">
                            ...
                            <label style="float: right;"><?php echo $so->item_sub_total;?></label>
                            <hr>
                        </div>
                    </div>
                    <div class="row" style="display: none;">
                        ...
                        <div class="col-md-3">
                            ...
                            <label style="float: right;"><?php echo $so->item_grand_total;?></label>
                            <hr>
                        </div>
                    </div>
                    ...
                    <br>
                    <br>
                    <a class="btn btn-secondary pull-right no-print" href="<?php echo URLROOT;?>/pages/salesorderprint/<?php echo $data['id'];?>">PRINT</a>
                    <button class="btn btn-primary pull-right no-print" onclick="window.print()"><i class="fa fa-print" aria-hidden="true"></i> PrintA4</button>
                    </div>
                </div>
            </div>
        </div>
