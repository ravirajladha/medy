...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?php echo URLROOT; ?>/pages/add_delivery_challan"><button class="btn btn-primary">New</button>
                </a>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="card-title mb-0">All Delivery Challans</h5>
                        </div>
                        <div class="col-6">
...
<script type="text/javascript">
  $(document).ready(function()
    ...
    var inc = 0;
        $.ajax({
        type: "POST",
        url: '<?php echo URLROOT;?>/pages/getAllDelivery_challans',
        data: {lim,off},
        cache: false,
        success:function(response)
        {
            $('#alldelivery_challan').html(response);
        }
        });
        ...
        if($(window).scrollTop() + $(window).height() >= $(document).height())
        {
            ...
            { 
                inc++;
                $('#alldelivery_challan').append(response);
            }
            });
        }
    });
