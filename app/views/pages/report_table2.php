...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Modelwise Wires Stock Report</h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo URLROOT;?>/assets/pages/index">Home</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo URLROOT;?>/assets/pages/index">Modelwise Wires Stock Report</a></li>
            ...
            <div class="card m-b-30">
                <div class="container">
                 <br>
                    ...
                    <h3 style='text-align: center;' class="mb-3" >Modelwise Wires Stock Report</h3>
...
<script type="text/javascript">
    ...
    { 
        ...
        window.location.href = '<?php  echo URLROOT;?>/pages/report_table_val1/'+ value;
