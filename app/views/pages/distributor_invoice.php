...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Distributor Order Invoice</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-5 col-lg-5">
                                    <div class="invoice-name">
                                        ...
                                        <p class="mb-1">No : <?php echo $data['dist']->distributor_id; ?></p>
                            ...
                            <div class="table-responsive ">
                                <table class="table">
                                    ...
                                    <?php
                                        $item_t_total=0;
                                        $t_tax = 0;
                                        $itemId = explode('|||', $data['dist']->item_id);
                                        $itemName = explode('|||', $data['dist']->item_name);
                                        $itemQty = explode('|||', $data['dist']->item_qty);
                                        $itemPrice = explode('|||', $data['dist']->item_price);
                                        $itemTax = explode('|||', $data['dist']->item_tax);
                                        $itemTotal = explode('|||', $data['dist']->item_total);
                                        $itemState = explode('|||', $data['dist']->item_state);
                                    ?>
                                    <tbody>
