      ...
      <!-- Start Breadcrumbbar -->                    
                <div class="breadcrumbbar">
                    <div class="row align-items-center">
                        <div class="col-lg-11">
                            <h4 class="page-title">Model wise Sorting</h4>
                            ...
                            <div class="card-header">                                
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        ...
                                        <h5 class="card-title mb-0" style="font-size: 28px;">Model wise sorting</h5>
                                        <br>
                                    ...
                                    <table class="table table-border">
                                        ...
                                        <tbody><?php $sum=0; $post = new Page(); ?>
                                            ...
                                            <tr>
                                                    ...
                                                    <td><?php echo $category_new_id; ?></td>
                                                    <td><?php echo $subcategory_new_id; ?></td>
                                                    <td><?php echo $k->brand;?></td>
                                                        ...
                                                        <td> <?php echo $k->committed_stock;  ?></td>
                                                      <td><?php echo $color_id;?></td>
                                                    <td><?php echo $size_id;?></td>

                                            </tr><?php $a++;?>
                                            <?php }?>
                                            <tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><?php echo "Total Stock: ";?></td><td><?php echo $sum;?></td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
