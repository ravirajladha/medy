...
<!-- End Breadcrumbbar -->
<!-- Start Contentbar -->
<form method="POST" action="<?php echo URLROOT; ?>/pages/create_delivery_challans" enctype="multipart/form-data" id="salesForm">
				...
				<div class="card m-b-30">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Customer Name" name="customer" id="cname" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" autocomplete="off" style="display: none;">
							...
							<select class="select2-single form-control" name="customer_id" id="cname_id" onchange="getbilladd(this.value)">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="bill_address" name="bill_address" rows="4"  readonly></textarea>
						</div>
						<div class="form-group" style="display: none;">
							<label>Delivery Challan#</label>
							<input type="text" class="form-control" placeholder="ex DC-00001" name="delivery_challan_no">
						</div>
						<div class="form-group">
							<label>State</label>
				...
				<div class="card m-b-30">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Challan Type" name="challan_type">
						</div>
						<div class="form-group">
...
<script>
	...
	function addRowForBill()
	{
		...
		else
		{
			...
			$.ajax({
				url: "<?php echo URLROOT; ?>/pages/tempdeliverychallanData",
				type: "POST",
				data: {
	...
	function getbilladd(cid) 
  	{
        ...
        $.ajax({
            url: '<?php echo URLROOT; ?>/pages/get_cu_bill1',
            type: "POST",
            data: {cid},
            success : function(res)
            {
                // $('#bill_address').html(res);
                document.getElementById("cname").value = res;
