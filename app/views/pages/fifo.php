            ...
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-7">
                        <h4 class="page-title">FIFO Cost Lot Tracking</h4>
                            ...
                            <div class="card-header">                                
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        ...
                                        <h5 class="card-title mb-0" style="font-size: 28px;">FIFO Cost Lot Tracking</h5>
                                        <br>
                                    ...
                                    <table class="table table-border" >
                                        ...
                                        <tbody>
                                            <tr>
                                                 ...
                                                 <td>10/07/2020</td>
                                                <td>Bill#BL-002</td>
                                                <td>Sir Sri Publications Trust</td>
                                               <th>Ganesha Rahashya</th>
                                                <td>1.00</td>
                                                <td>830.0</td>
