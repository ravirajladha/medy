<?php require APPROOT . '/views/inc/header.php'; ?>
            ...
            <?php $cust = $data['customer']; ?>

            <!-- End Breadcrumbbar -->
            <!-- Start Contentbar -->
            <form action="<?php echo URLROOT; ?>/pages/update_customer" method="POST" > 
                        ...
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <?php if($cust->customer_type == "Business"){ ?>
                                        
                                        <input checked type="radio" class="chb" name="business" value="Business"> Bussiness 
                                        ...
                                        <?php }else{?>
                                         ...
                                         <input checked type="radio" class="chb" name="individual" value="Individual"> Individual
                                       <?php }?>
                                    </div>

                                    <div class="form-group">
                                        <label > Customer Priority: </label>&nbsp;
                                        <?php if($cust->cp_priority == 1){ ?>
                                        
                                        <input checked type="radio" class="chb1" name="cphigh" value="High"> High 
                                         <input type="radio" class="chb1" name="cplow" value="Low"> Low
                                        <?php }else{?>
                                          <input type="radio" class="chb1" name="cphigh" value="High"> High 
                                         <input checked type="radio" class="chb1" name="cplow" value="Low"> Low
                                       <?php }?>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                <select class="form-control" id="formControlSelect" name="salutation">
                                                    <option selected=""><?php echo $cust->customer_sa;?></option>
                                             ...
                                             <div class="col-md-4">
                                                <input type="text" class="form-control" placeholder="First Name" name="f_name" value="<?php echo $cust->customer_first_name;?>">
                                             </div>
                                             <div class="col-md-4 form-group">
                                                 <input type="text" class="form-control" placeholder="Last Name" name="l_name" value="<?php echo $cust->customer_last_name;?>">
                                             </div>
                                         </div>
                                     ...
                                     <div class="form-group">
                                        <label >Company Name</label>
                                         <input type="text" class="form-control" placeholder="" name="company_name" value="<?php echo $cust->company_name;?>">
                                     ...
                                     <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="c_display_name" value="<?php echo $cust->customer_display_name;?>">
                                    </div>
                        ...
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="" name="c_email" value="<?php echo $cust->customer_email;?>">
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                <input type="number" class="form-control" placeholder="Home" name="customer_home_phone" value="<?php echo $cust->customer_phno_home;?>">
                                             </div>
                                             <div class="col-md-6 form-group">
                                                 <input type="number" class="form-control" placeholder="Work" name="customer_work_phone" value="<?php echo $cust->customer_phno_work;?>">
                                             </div>
                                         </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label >Website</label>
                                        <input type="text" class="form-control" name="website" value="<?php echo $cust->customer_website;?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="transport" id="transport">
                                            ...
                                            <option value="<?php echo $k->id ?>" <?php if ($cust->transport == $k->id) { ?> selected <?php } ?>><?php echo $k->name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                             ...
                                             <div class="col-lg-6">
                                                <div class="card m-b-30">
                                                    <div class="card-body">
                                                              ...
                                                              <div class="form-group">
                                                                <label >GST NO</label>
                                                                <input type="text" class="form-control" placeholder="Gst No" name="gst" value="<?php echo $cust->gst;?>">
                                                          
                                                            </div>
                                                            <div class="form-group">
                                                                <label >Aadhar No</label>
                                                                <input type="text" class="form-control" placeholder="Aadhar No" name="aadhar" value="<?php echo $cust->aadhar;?>">
                                                              
                                                            </div>
                                                             <div class="form-group">
                                                                <label >Passport NO</label>
                                                                <input type="text" class="form-control" placeholder="Passport NO" name="passport" value="<?php echo $cust->passport;?>">
                                                ...
                                                <div class="card m-b-30">
                                                    <div class="card-body">
                                                              ...
                                                              <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control" placeholder="DOB" name="dob" value="<?php echo date('Y-m-d',strtotime($cust->dob));?>" >
                                                          
                                                            </div>
                                                            <div class="form-group">
                                                                <label >Aniversary Date </label>
                                                                <input type="date" class="form-control" placeholder="Aniversary date" name="aniversary" value="<?php echo date('Y-m-d',strtotime($cust->aniversary));?>">
                                                              
                                                            </div>
                                                             <div class="form-group">
                                                                <label >Blood Group</label>
                                                                <input type="text" class="form-control" placeholder="Blood Group" name="blood" value="<?php echo $cust->blood; ?>">
