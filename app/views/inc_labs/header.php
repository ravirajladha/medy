        ...
        <aside class="left-panel">
            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/labs/index"><i class="ion-home"></i> <span class="nav-label">Dashboard</span></a>
                    </li>
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/labs/orders"><i class="ion-flask"></i> <span class="nav-label">Orders</span></a>
                    </li>
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/labs/test_group"><i class="ion-settings"></i> <span class="nav-label">Test Groups</span></a>
                    </li>
                    <li class="has-submenu"><a href="<?php echo URLROOT;?>/labs/new_test"><i class="ion-compose"></i> <span class="nav-label">New Test</span></a>
                    </li>
                    <li class="has-submenu"><a href="#"><i class="ion-document"></i> <span class="nav-label">X-ray Reports</span></a>
                        <ul class="list-unstyled">
                            <li><a href="<?php echo URLROOT;?>/labs/new_xray">X-ray Report Upload</a></li>
                            <li><a href="<?php echo URLROOT;?>/labs/allxraydetails">All X-ray Reports</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>         
        ...
        <section class="content">
            ...
            <header class="top-head container-fluid">
                ...
                <form role="search" class="navbar-left app-search pull-left hidden-xs">
                  <input type="text" placeholder="Test Search..." class="form-control">
                </form>
                ...
                <ul class="list-inline navbar-right top-menu top-right-menu">  
                    ...
                    <li class="dropdown text-center">
                        ...
                        <ul class="dropdown-menu extended pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                            ...
                            <li><a href="<?php echo URLROOT;?>/labs/settings"><i class="fa fa-cog"></i> Settings</a></li>
