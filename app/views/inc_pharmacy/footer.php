        ...
        <!-- datatable -->
         <script src="<?php echo URLROOT;?>/assets/datatables/jquery.dataTables.min.js"></script>
        <script src="<?php echo URLROOT;?>/assets/datatables/dataTables.bootstrap.js"></script>
...
<footer class="footer check_size">
    <?php $yr = date('Y');?>
    <?php echo $yr;?> © MedHike 
    <a href="http://www.kods.co" target="_blank"><span style="float: right; color: gray;">Med Hike Pvt. Ltd.</span></a>
</footer>
<footer class="footer check_size1">
    <center style="color: gray" >
    <?php $yr = date('Y');?>
    <?php echo $yr;?> © MedHike <br>
    <a href="http://www.kods.co" target="_blank"><span style="color: gray;">Med Hike Pvt. Ltd.</span></a></center>
</footer>
            <!-- Footer Ends -->
