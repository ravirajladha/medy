    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <select class="form-control" style="float: right;width: 200px;" onchange="location = this.value;">
              ...
              <option value="<?php echo URLROOT; ?>/receptions/all_orders_lab" >Lab Orders</option>
              <option value="<?php echo URLROOT; ?>/receptions/all_orders_bal" selected="">Balance Orders</option>
              <option value="<?php echo URLROOT; ?>/receptions/all_orders_discount" selected="">Discount Orders</option>
            </select>
            <div class="" ><h3 class="panel-title">List of Discount Orders</h3></div>
  ...
  $(document).ready(function()
          {
            ...
            var inc = 0;
              $.ajax({
                type: "POST",
                url: '<?php echo URLROOT;?>/receptions/all_orders_discount1',
                data: {lim,off},
                cache: false,
