        ...
        <div class="panel panel-default">
            ...
            <div class="row">
             <div class="col-sm-6" style="margin-top: 15px">
                <input type="number" id="service_id_value" name="example-input2-group2" class="form-control" placeholder="Search By Service ID" autocomplete="off">
             </div>
             <div class="col-sm-6" style="margin-top: 15px">
                    ...
                    <div class="col-md-12">
                      <div class="table-responsive">
                          <table class="table">
                              <thead>
                                  <tr>
                                      <th class="col-md-1" style="text-align: left;">Service ID</th>
                                      <th class="col-md-3" style="text-align: left;">Services</th>
                                      <th class="col-md-3" style="text-align: left;">Type</th>
                                      <th class="col-md-2" style="text-align: left;">Cost</th>
                                  </tr>
                              </thead>
