	...
	$(document).ready(function()
					{
						...
						var inc = 0;
							$.ajax({
								type: "POST",
								url: '<?php echo URLROOT;?>/receptions/all_orders_active',
								data: {lim,off},
								cache: false,
	...
	$(document).ready(function(){
				$("#invoice_id_value").keyup(function(){
					...
					if(inv!=0)
					{
						$.ajax({
							type:'POST',
							url:'<?php echo URLROOT;?>/receptions/all_orders_active_by_id',
							data:{inv},
	...
	$(document).ready(function(){
				$("#search_by_name_value").keyup(function(){
					...
					if(patient_name!=0)
					{
						$.ajax({
							type:'POST',
							url:'<?php echo URLROOT;?>/receptions/search_by_name_value_active',
							data:{patient_name},
							success : function(data)
							{
								$('#all_orders').html(data);
	...
	$(document).ready(function(){
				$("#get_wrt_date").click(function(){
					...
					if(start != '' && end != '')
					{
						$.ajax({
							type:'POST',
							url:'<?php echo URLROOT;?>/receptions/get_all_orders_wrt_dates_active',
							data:{start, end},
							success : function(data)
							{
								$('#all_orders').html(data);
