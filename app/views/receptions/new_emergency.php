...
<div class="row">
	<div class="col-md-12">
        ...
        <div class="panel-heading"><h3 class="panel-title">Create Emergency</h3>
        </div>
            <div class="panel-body " >
              ...
              <div class="first_div">
                  <div class="form-group">
                    <button style="margin-top: 34px" id="op_visit" type="button" class="btn btn-info w-md m-b-5">Create Emergency</button>
                  </div>
              </div>
              <div class="sec_div" style="display: none;">
                      ...
                      <div class="form-group">
                       <button style="margin-top: 34px; float:right;" id="op_visit1" type="button" class="btn btn-info w-md m-b-5">Create Emergency</button>
                      </div>
              </div>
					</div>
...
<script type="text/javascript">
	$('#op_visit').click(function(){
		...
		$.ajax({
			url:'<?php echo URLROOT;?>/receptions/create_emergency',
			type:'POST',
			data:{p_name,d_name},
