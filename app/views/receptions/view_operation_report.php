...
<div class="wraper container-fluid" >
            ...
            <?php echo date('d-m-Y h:i A',strtotime($data['admission_date_time'])); ?></p>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table m-t-30">
                                                ...
                                                <tbody>
                                                         ...
                                                         <?php foreach ($data['fix_service'] as $key) {
                                                           ?>
                                                           <tr>
                                                       ...
                                                       <tr>
                                                        ...
                                                        <td style="text-align: left; padding-left: 100px;"><?php echo $key->services;?></td>
                                                       ...
                                                       <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left; padding-left: 100px;">Total Cost</td>
                                                            <td style="font-weight: 700;"><?php echo $data['sum']." Rs.";?></td>
                                                        </tr>
                                ...
                                <div class="hidden-print">
                                    <div class="pull-right">
                                        <a href="<?php echo URLROOT;?>/receptions/print_operation_details/<?php echo $data['ot_id'];?>" class="btn btn-success">&nbsp;<i class="fa fa-print"></i> &nbsp;Print</a>
                                    </div>
                                </div>
                            </div>
                        </div>
