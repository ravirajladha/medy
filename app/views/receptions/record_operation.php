					...
					<div class="col-md-12">
            				<div class="panel-heading" style="border: none;"><h3 class="panel-title">Operation Reports</h3></div>
                				<div class="panel-body" style="border: none;" >
                					<form method="POST" action="<?php echo URLROOT;?>/receptions/to_from_report">
	                					<div class="col-md-4">
									...
									<div class="col-md-2">
							            <div class="form-group">
										<a href="<?php echo URLROOT;?>/receptions/day_report1">
									...
									<div class="col-md-2">
							            <div class="form-group">
										   <a href="<?php echo URLROOT;?>/receptions/monthly_report1">
									...
									<div class="col-md-2">
							            <div class="form-group">
										   <a href="<?php echo URLROOT;?>/receptions/yearly_report1">
