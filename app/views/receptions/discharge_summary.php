                            ...
                            <div class="panel-body">
								...
								<div class="m-h-50">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                            <strong>
                                                Discharge type: </strong><?php echo $d_type;?>
                                                <br>
											<strong>    
												Remark: </strong><?php echo $remark; ?>
                                            </p>
                                ...
                                <div class="m-h-50">
                                    <div class="row">
                                        <div class="col-md-12">
                                        	<p>
                                            <strong>
                                                Patient History: </strong> <?php echo $pat_h;?>
                                                <br>
											<strong>
                                                Patient Family History: </strong><?php echo $pat_fh; ?>
                                            </p>
								...
								<div class="m-h-50">
                                    <div class="row">
                                        <div class="col-md-12">
											<?php 
											foreach ($data['ipd'] as $k) {
                                            ?>
                                        	<p>
                                            <strong>
												Initial Condition: 
											</strong> 
											<?php echo ucwords($k->ipd_initial_condition); ?>
                                            <br>
											<strong>
												First Diagnosis: 
											</strong>
											<?php echo ucwords($k->ipd_first_diagnosis); ?>
											<br>
											<strong>
												Final Diagnosis: 
											</strong>
											<?php 
												$a='';
												foreach ($data['ipd_days_data'] as $gg) 
												{  	
													$a=$gg->ipd_day_diagnosis;
												}
												echo ucwords($a);
											?>
                                            </p>
                                ...
                                <div class="col-md-12">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table m-t-30">
                                               <h4>Date: <?php echo date('d-m-Y', strtotime($test->ipd_day_val)); ?></h4>
                                                <thead>
                                                    <tr>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p>
                                            Review as advised with <strong><?php echo ucwords($doctor_name);?>  </strong> with prior appointment.
                                            </p>
                                        </div>
    ...
    var mediaQueryList = window.matchMedia('print');
        mediaQueryList.addListener(function(mql) {
            if (mql.matches) {
                ...
                window.location.replace('<?php echo URLROOT; ?>/receptions/view_profile_patient/<?php echo $patient_id; ?>');
            }
        });
</script>