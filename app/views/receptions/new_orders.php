          ...
          <table class="table table-bordered table-hover" id="tab_logic">
            ...
            <?php if (isset($data['edit_order_details'])) { 
              foreach ($data['edit_order_details'] as $val)
              {
                ...
                $e_advance_pay = $val->advance_pay;
                $e_authorized_by = $val->authorized_by;
              }
      ...
      <table class="table table-bordered table-hover" id="tab_logic_total">
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
                <input type="text" class="form-control" id="authorized_by" placeholder="Enter Name" name="authorized_by" value="<?php echo $e_authorized_by; ?>">
             </td>
          </tr>
      ...
      <table class="table table-bordered table-hover" id="tab_logic_total">
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
                <input type="number" id="advance_pay" class="form-control" placeholder="0" name="advance_pay" value="<?php echo $e_advance_pay; ?>">
            </td>
          </tr>
        </tbody>
      </table>
