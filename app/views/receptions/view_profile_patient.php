            ...
            <div class="panel panel-default p-0">
                <div class="panel-body p-0"> 
                        ...
                        <div id="aboutme" class="tab-pane active">
                            <div class="box-layout meta bottom" >
                                <div class="col-sm-12 clearfix ">
                                    <div class="row">
                                        <div class="col-md-1">
                                            <span class="img-wrapper pull-left m-r-15" style="margin-top: 4px;"><img src="<?php echo URLROOT;?>/patient_photos/<?php echo $photo; ?>" alt="" style="width:64px; height: 65px!important;" class="br-radius"></span>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <span style="float: right;"><a href="<?php echo URLROOT; ?>/receptions/edit_patient/<?php echo $patient_id; ?>"><i class="fa fa-pencil" aria-hidden="true">&nbsp;&nbsp;</i><u>Edit Info</u></a></span>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <a href="#" class="ng-binding">
                                           <?php 
                                                if(date('d-m-Y',strtotime($dob)) == date('d-m-Y', strtotime('0000-00-00')))
                                                {
                                                    echo $age.'(age)';
                                                }
                                                else
                    ...
                    <div id="user-activities" class="tab-pane">
                        ...
                        <div class="timeline-2">
                            <div class="time-item">
                                <div class="item-info">
                                    ...
                                    if(!empty($doc_name)){
                                    ?>
                                    <span class="text-info">Dr. 
                                    <?php
                                    echo ucwords($doc_name);
                                    } else {
                                        echo "No Doctor mentioned";
                                    }
                                    ?></span></strong></p>
                                    ...
                                    <div class="modal-content"> 
                                        ...
                                        <div class="modal-body"> 
                                            <div class="row"> 
                                                ...
                                                <div class="col-md-2"> 
                                                    <a href="<?php echo URLROOT;?>/doctors/print_prescription/<?php echo $visit_id;?>"><button type="button" class="btn btn-success w-xs m-b-5"> Print </button></a><br>
                        ...
                        <?php } ?> <div><a style="color: orange;" href="<?php echo URLROOT; ?>/receptions/print_invoice_for_all/<?php echo $p_id; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Print All Bill</a></div>
                    </div>
                        ...
                        <div class="timeline-2">
                            <div class="time-item">
                                <div class="item-info">
                                    ...
                                    <a href="<?php echo URLROOT; ?>/receptions/print_invoice_for_all_ip/<?php echo $p_id; ?>"><button class="btn btn-purple btn-xs m-b-5">Print All Bill</button></a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
