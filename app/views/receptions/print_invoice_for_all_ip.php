...
<div class="wraper container-fluid" >
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="pull-right m-t-30">
                                            <p><strong> Date: </strong><?php echo date('d-m-Y', strtotime($invoice_date));?></p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td></i>&nbsp;<?php echo $inv_item[($t*4)+3]; 
            $z=(int)$z + $inv_item[($t*4)+3];?></td>
        </tr>
    <?php $n++; } $dis = (int)$dis + $invoice_discount;
        $amt = (int)$amt + $amount_paid;?> 
     <?php 
                                    $i++;
                                         }
                                ?>
                                ...
                                <div class="row" style="border-radius: 0px;">
                                    <div class="col-md-3 col-md-offset-9">
                                        <p class="text-right"><b>Sub-total:</b> &nbsp;&nbsp;₹ <?php echo $z;?></p>
                                        <p class="text-right" style="padding-right: 7px;"><b>Discount:</b> &nbsp;&nbsp;₹ <?php echo $dis; ?>
                                        </p>
                                        <p class="text-right" style="padding-right: 7px;"><b>Total amount:</b> &nbsp;&nbsp;₹ <?php echo (int)$z - (int)$dis; ?>
                                        </p>
                                        <p class="text-right" style="padding-right: 7px;"><b>Total amount paid:</b> &nbsp;&nbsp;₹ <?php echo $amt; ?>
                                        </p>
                                        <p class="text-right" style="padding-right: 7px;"><b>Remaining amount:</b> &nbsp;&nbsp;₹ <?php echo $z - $amt ; ?>
                                        </p>

                                        <hr>
                                            <h3 class="text-right">₹ <?php echo $amt;?>.00</h3>
                                    </div>
                                </div>
                                ...
                                <div class="hidden-print">
                                    <div class="pull-right">
                                        <a href="<?php echo URLROOT;?>/receptions/print_invoice_for_all_ip/<?php echo $ppid;?>" class="btn btn-success">&nbsp;<i class="fa fa-print"></i> &nbsp;Print</a>
                                    </div>
                                </div>
                            </div>
                        </div>
