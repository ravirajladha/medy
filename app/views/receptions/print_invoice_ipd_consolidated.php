			...
			<div class="row">
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th style="text-align: left; width: 400px;">Particulars</th>
										<th></th>
										<th></th>
				...
				<?php
					...
					{ 
						...
						?>
						<tr>
							<td style="text-align: left; width: 50px;"><?php echo $po+1; ?></td>
							<td style="text-align: left; width: 400px;"><?php echo $sorted_array[$po] ?></td>
							<td></td>
							<td></td>
							<td style="text-align: left;"><?php echo $sub_ttl; ?></td>
						</tr>
				<?php
				$alltotal += $sub_ttl;
					}
				?>
								<tr>
									<td style="text-align: left; width: 50px;"><?php echo $po+1; ?></td>
									<td style="text-align: left; width: 400px;">Laboratory Investigations</td>
									<td></td>
									<td></td>
									<td style="text-align: left;"><?php echo $tt_gen1; ?></td>
								</tr>
								<tr>
									<td style="text-align: left; width: 50px;"><?php echo $po+2; ?></td>
									<td style="text-align: left; width: 400px;">Medicine</td>
									<td></td>
									<td></td>
									<td style="text-align: left;"><?php echo $tot; ?></td>
								</tr>
								</tbody>
							</table>
						</div>
                                ...
                                <div class="row container" style="border-radius: 0px;">
                                    ...
                                    <div class="col-md-3 col-md-offset-9">
										<p class="text-right" style="padding-right: 7px;"><b>Total Bill amount(Rs):</b> <?php echo (int)$tot + (int)$alltotal + (int)$tt_gen1;?>
										</p>
									</div>
									<div class="col-md-3 col-md-offset-9">
										<p class="text-right" style="padding-right: 7px;"><b>Net Bill amount(Rs):</b> <?php echo (int)$tot + (int)$alltotal + (int)$tt_gen1;?>
										</p>
									</div>
									<div class="col-md-3 col-md-offset-9">
									...
									<div class="col-md-3 col-md-offset-9">
										<p class="text-right" style="padding-right: 7px;"><b>Balance(Rs):</b> <?php echo (int)$tot + (int)$alltotal + (int)$tt_gen1 - $data['advance']?>
										</p>
									</div>
                                </div>
