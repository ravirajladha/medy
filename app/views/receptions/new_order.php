      ...
      <form id="fed">
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-hover" id="tab_logic">
            ...
            <?php if (isset($data['ipdDays'])) { 
              $idArray = array();
              $qtyArray = array();
              foreach ($data['ipdDays'] as $val)
              {
                $ipd_nursing_service = explode(',', $val->nursing_service);
...
<script type='text/javascript'>
  function xsave(b)
  {
    ...
    $.ajax({
              ...
              type:'POST',
              data:{inv_id_edit,status,service_id,invoice_bill,grand_total,patient_name,doctor_name,ipopid,pay_mode,amount_paid,dep_type,b,taxx,dist,advance_pay},
              success : function(data)
              {
