                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($p->status == '3') 
                                        { ?>
                                              <a href="<?php echo URLROOT; ?>/receptions/print_operation_details/<?php echo $p->ot_id; ?>"><button style="width: 54px;" type="button" class="btn btn-success btn-xs m-b-5">Print</button></a>
                                              <a href="<?php echo URLROOT; ?>/receptions/view_operation_report/<?php echo $p->ot_id; ?>"><button style="width: 54px;" type="button" class="btn btn-purple btn-xs m-b-5">View</button></a>
                                      <?php }
                                      elseif ($p->status == '4') 
                                      { ?>
                                                <a href="#"><button style="width: 64px;" type="button" class="btn btn-danger btn-xs m-b-5">Cancelled</button></a>

                                    <?php } 
                                    else
                                    { ?>
                                        <a href="#"><button style="width: 54px;" type="button" class="btn btn-info btn-xs m-b-5">Pending</button></a>
                                   <?php }
